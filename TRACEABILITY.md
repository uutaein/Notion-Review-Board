...
| 7.2 Review Source 등록  | SRS-FR-010 ~ 013                          | `feature/review-source/review-source.feature`                                                                    | `docs/test-cases/review-source-field-mapping.md`; TC-SOURCE-001 ~ 034; TC-SOURCE-IPC-001 ~ 005; TC-SOURCE-UI-001/002/003/008 | `src/main/services/source/index.ts`; `src/main/ipc/source-mapping.ts`; `src/renderer/src/composables/useReviewSourceSettings.ts`; service, IPC, preload, renderer state-model tests, and mock-browser tab/UI verification pass                                              | Partially Verified |
...
| 7.6 오늘 복습 목록      | SRS-FR-050 ~ 054                          | `feature/today-review/today-review.feature`                                                                      | `docs/test-cases/today-review.md`; TC-REVIEW-001 ~ 015; TC-REVIEW-UI-001/002                                                 | `src/main/services/review/index.ts`; `src/main/ipc/today-review.ts`; `src/preload/index.ts`; `src/renderer/src/composables/useTodayReview.ts`; backend, IPC, preload, renderer state-model, and database tests pass; live Electron/Notion display remains unverified        | Partially Verified |
