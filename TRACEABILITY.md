...
| 7.2 Review Source 등록  | SRS-FR-010 ~ 013                          | `feature/review-source/review-source.feature`                                                                    | `docs/test-cases/review-source-field-mapping.md`; TC-SOURCE-001 ~ 027; TC-SOURCE-IPC-001 ~ 005; TC-SOURCE-UI-001/002/003/008 | `src/main/services/source/index.ts`; `src/main/ipc/source-mapping.ts`; `src/renderer/src/composables/useReviewSourceSettings.ts`; service, IPC, preload, renderer state-model tests, and mock-browser tab/UI verification pass                                              | Partially Verified |
