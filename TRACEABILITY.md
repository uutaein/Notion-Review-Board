...
| 7.2 Review Source 등록  | SRS-FR-010 ~ 013                          | `feature/review-source/review-source.feature`                                                                    | `docs/test-cases/review-source-field-mapping.md`; TC-SOURCE-001 ~ 034; TC-SOURCE-IPC-001 ~ 005                     | `src/main/services/source/index.ts`; `src/main/ipc/source-mapping.ts`; `src/main/services/source/__tests__/source.test.ts`; `src/main/ipc/__tests__/source-mapping.test.ts`                                                                                                 | Partially Verified |
